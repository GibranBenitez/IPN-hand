...
if __name__ == '__main__':
    ...
    for class_type in ['all', 'all_but_None', 'binary']:
        ...
        val_csv_path = os.path.join(csv_dir_path, 'vallist'+ class_type + sens + '.txt')
        dst_json_path = os.path.join(csv_dir_path, 'ipn' + class_type + sens + '.json')
...
# HOW TO RUN:
# python utils/ipn_json.py ./annotation_ipnGesture frames &
# python utils/ipn_json.py ./annotation_ipnGesture segment &
# python utils/ipn_json.py ./annotation_ipnGesture flow &