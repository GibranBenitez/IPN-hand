...
dataset_path = "/host/space0/gibran/dataset/Nvidia/nvgesture_arch"
            ...
            for param in params[1:]:
                    ...
                    if key == 'label':
                        ...
                        if key == 'color':
                            key2 = 'flow'
                            key3 = 'segment'
                            params_dictionary[key2] = path + '/sk_flow'
                            params_dictionary[key3] = path + '/sk_segment'
                            params_dictionary[key2+'_start'] = int(parsed[2])
                            params_dictionary[key3+'_start'] = int(parsed[2])
                            params_dictionary[key2+'_end'] = int(parsed[3])
                            params_dictionary[key3+'_end'] = int(parsed[3])
...
if __name__ == "__main__":
    ...
    sens = sys.argv[4]     # [all, all_but_None, binary]
    sensors = [sens]

    # sensors = ["segment"]
    # # subset = "training" 
    # subset = "validation" 
    # file_name = "vallistall_but_None_seg.txt"
    # class_types = "all_but_None"
